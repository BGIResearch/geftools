...
void test_getDnbStatMatrix() {
    ...
    CommonBin common_bin_gef = CommonBin("/Users/huangzhibo/workitems/13.github/gefpy/test_data/barCode_gef/stereomics.h5", 1);
    cout << "/Users/huangzhibo/workitems/13.github/gefpy/test_data/barCode_gef/stereomics.h5" << endl;
...
//    unsigned int x0 = 52, x1 = 56, y0 = 39, y1 = 42;
    ...
    Mat valid_dnb_mat = Mat::zeros(cols, rows, CV_8UC1);
//    unsigned char * m;
//    m = static_cast<unsigned char *>(malloc((x1 - x0 + 1) * (y1 - y0 + 1) * sizeof(unsigned char)));
//
    common_bin_gef.getDnbStatMatrixT(x0, y0, rows, cols,valid_dnb_mat.data);
